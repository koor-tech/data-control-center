            ...
            <div class="p-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0 w-8 my-auto" v-if="notification.type">
                        <CheckCircleIcon v-if="notification.type === 'success'" class="text-success-400"
                            aria-hidden="true" />
                        <InformationIcon v-else-if="notification.type === 'info'" class="text-info-400"
                            aria-hidden="true" />
                        <AlertIcon v-else-if="notification.type === 'warning'" class="text-warn-400" aria-hidden="true" />
                        <AlertCircleIcon v-else-if="notification.type === 'error'" class="text-error-400"
                            aria-hidden="true" />
                    </div>
