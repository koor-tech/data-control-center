...
import { HarddiskIcon } from 'mdi-vue3';
import type { Data } from '~~/gen/ts/api/resources/stats/v1/stats_pb';
...
<template>
    <ServiceBox :icon="markRaw(HarddiskIcon)">
        <template #default> Volumes </template>
        <template #content>
            <ServiceLiItem>
