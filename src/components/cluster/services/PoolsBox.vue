...
import { PoolIcon } from 'mdi-vue3';
import type { Pools } from '~~/gen/ts/api/resources/stats/v1/stats_pb';
...
<template>
    <ServiceBox :icon="markRaw(PoolIcon)">
        <template #default> Pools </template>
        <template #content>
            <ServiceLiItem>
