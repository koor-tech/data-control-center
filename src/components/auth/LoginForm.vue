...
const { loginStart, loginStop, setPermissions, setAccessToken } = authStore;
    ...
    <form @submit="onSubmit" class="my-2 space-y-6">
        <template v-if="appConfig.login.providers.length === 0">
            <div>
                ...
                <div>
                    <VeeField name="username" type="text" autocomplete="username" placeholder="Username" label="Username"
            ...
            <div>
                ...
                <div>
                    <VeeField name="password" type="password" autocomplete="current-password" placeholder="Password"
                        label="Password"
                        class="block w-full rounded-md border-0 py-1.5 bg-base-700 text-neutral placeholder:text-base-200 focus:ring-2 focus:ring-inset focus:ring-base-300 sm:text-sm sm:leading-6" />
