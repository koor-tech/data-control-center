...
const (
	AuthService_Login_FullMethodName      = "/api.services.auth.v1.AuthService/Login"
	AuthService_Logout_FullMethodName     = "/api.services.auth.v1.AuthService/Logout"
	AuthService_CheckToken_FullMethodName = "/api.services.auth.v1.AuthService/CheckToken"
)
