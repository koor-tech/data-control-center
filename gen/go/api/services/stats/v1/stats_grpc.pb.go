...
func (c *statsServiceClient) GetClusterStats(ctx context.Context, in *GetClusterStatsRequest, opts ...grpc.CallOption) (*GetClusterStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.services.stats.v1.StatsService/GetClusterStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsServiceClient) GetClusterResources(ctx context.Context, in *GetClusterResourcesRequest, opts ...grpc.CallOption) (*GetClusterResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.services.stats.v1.StatsService/GetClusterResources", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsServiceClient) GetClusterNodes(ctx context.Context, in *GetClusterNodesRequest, opts ...grpc.CallOption) (*GetClusterNodesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.services.stats.v1.StatsService/GetClusterNodes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsServiceClient) GetClusterRadar(ctx context.Context, in *GetClusterRadarRequest, opts ...grpc.CallOption) (*GetClusterRadarResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.services.stats.v1.StatsService/GetClusterRadar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsServiceClient) GetKoorCluster(ctx context.Context, in *GetKoorClusterRequest, opts ...grpc.CallOption) (*GetKoorClusterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.services.stats.v1.StatsService/GetKoorCluster", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatsService_GetClusterStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.services.stats.v1.StatsService/GetClusterStats",
	}
...
func _StatsService_GetClusterResources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.services.stats.v1.StatsService/GetClusterResources",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatsService_GetClusterNodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.services.stats.v1.StatsService/GetClusterNodes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatsService_GetClusterRadar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.services.stats.v1.StatsService/GetClusterRadar",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatsService_GetKoorCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.services.stats.v1.StatsService/GetKoorCluster",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var StatsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.services.stats.v1.StatsService",
	...
	Metadata: "api/services/stats/v1/stats.proto",
}
