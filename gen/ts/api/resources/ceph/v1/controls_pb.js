...
export const OSDScrubbingSchedule = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "min_scrub_interval", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 8, name: "max_scrub_interval", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 9, name: "deep_scrub_interval", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
