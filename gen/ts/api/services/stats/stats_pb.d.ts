...
export declare enum PodStatus {
  /**
   * @generated from enum value: POD_UNKNOWN = 0;
   */
  POD_UNKNOWN = 0,

  /**
   * @generated from enum value: POD_NOT_RUNNING = 1;
   */
  POD_NOT_RUNNING = 1,

  /**
   * @generated from enum value: POD_RUNNING = 2;
   */
  POD_RUNNING = 2,
}
 ...
 */
export declare class PodInfo extends Message<PodInfo> {
  /**
  ...
  /**
   * @generated from field: stats.PodStatus status = 3;
   */
  status: PodStatus;

  constructor(data?: PartialMessage<PodInfo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "stats.PodInfo";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PodInfo;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PodInfo;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PodInfo;

  static equals(a: PodInfo | PlainMessage<PodInfo> | undefined, b: PodInfo | PlainMessage<PodInfo> | undefined): boolean;
}

/**
 * @generated from message stats.ListPodInfoResponse
 */
export declare class ListPodInfoResponse extends Message<ListPodInfoResponse> {
  /**
   * @generated from field: repeated stats.PodInfo pods = 1;
   */
  pods: PodInfo[];

  constructor(data?: PartialMessage<ListPodInfoResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "stats.ListPodInfoResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListPodInfoResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListPodInfoResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListPodInfoResponse;

  static equals(a: ListPodInfoResponse | PlainMessage<ListPodInfoResponse> | undefined, b: ListPodInfoResponse | PlainMessage<ListPodInfoResponse> | undefined): boolean;
}
...
export declare class ResourceInfo extends Message<ResourceInfo> {
  ...
  /**
   * @generated from field: stats.ResourceStatus status = 4;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "stats.ResourceInfo";
  static readonly fields: FieldList;
 ...
 */
export declare class ListCephResourcesResponse extends Message<ListCephResourcesResponse> {
  /**
   * @generated from field: repeated stats.ResourceInfo resources = 1;
   */
  resources: ResourceInfo[];

  constructor(data?: PartialMessage<ListCephResourcesResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "stats.ListCephResourcesResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListCephResourcesResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListCephResourcesResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListCephResourcesResponse;

  static equals(a: ListCephResourcesResponse | PlainMessage<ListCephResourcesResponse> | undefined, b: ListCephResourcesResponse | PlainMessage<ListCephResourcesResponse> | undefined): boolean;
}
