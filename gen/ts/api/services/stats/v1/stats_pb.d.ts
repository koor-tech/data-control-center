...
import type { ClusterRecommendation } from "../../../resources/ceph/v1/recommendations_pb.js";
...
/**
 * @generated from message api.services.stats.v1.ListClusterRecommendationsRequest
 */
export declare class ListClusterRecommendationsRequest extends Message<ListClusterRecommendationsRequest> {
  constructor(data?: PartialMessage<ListClusterRecommendationsRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.services.stats.v1.ListClusterRecommendationsRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListClusterRecommendationsRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListClusterRecommendationsRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListClusterRecommendationsRequest;

  static equals(a: ListClusterRecommendationsRequest | PlainMessage<ListClusterRecommendationsRequest> | undefined, b: ListClusterRecommendationsRequest | PlainMessage<ListClusterRecommendationsRequest> | undefined): boolean;
}

/**
 * @generated from message api.services.stats.v1.ListClusterRecommendationsResponse
 */
export declare class ListClusterRecommendationsResponse extends Message<ListClusterRecommendationsResponse> {
  /**
   * @generated from field: repeated api.resources.ceph.v1.ClusterRecommendation recommendations = 1;
   */
  recommendations: ClusterRecommendation[];

  constructor(data?: PartialMessage<ListClusterRecommendationsResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.services.stats.v1.ListClusterRecommendationsResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListClusterRecommendationsResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListClusterRecommendationsResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListClusterRecommendationsResponse;

  static equals(a: ListClusterRecommendationsResponse | PlainMessage<ListClusterRecommendationsResponse> | undefined, b: ListClusterRecommendationsResponse | PlainMessage<ListClusterRecommendationsResponse> | undefined): boolean;
}
