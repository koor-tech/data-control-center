...
import { ClusterRecommendation } from "../../../resources/ceph/v1/recommendations_pb.js";
 ...
 */
export const ListClusterRecommendationsRequest = proto3.makeMessageType(
  "api.services.stats.v1.ListClusterRecommendationsRequest",
  [],
);
 ...
 */
export const ListClusterRecommendationsResponse = proto3.makeMessageType(
  "api.services.stats.v1.ListClusterRecommendationsResponse",
  () => [
    { no: 1, name: "recommendations", kind: "message", T: ClusterRecommendation, repeated: true },
  ],
);
