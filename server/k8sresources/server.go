...
import (
	...
	"github.com/koor-tech/data-control-center/gen/go/api/services/k8sresources/v1/k8sresourcesv1connect"
...
type Server struct {
	k8sresourcesv1connect.K8SResourcesServiceHandler
...
func (s *Server) RegisterService(g *gin.RouterGroup) {
	path, handler := k8sresourcesv1connect.NewK8SResourcesServiceHandler(s, connect.WithInterceptors(
