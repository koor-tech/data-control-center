...
func (s *Server) GetTroubleshootReport(ctx context.Context, req *connect.Request[pb.GetTroubleshootReportRequest]) (*connect.Response[pb.GetTroubleshootReportResponse], error) {
	...
	res := connect.NewResponse(&pb.GetTroubleshootReportResponse{
		Report: buf.String(),
	})
	return res, nil
}
